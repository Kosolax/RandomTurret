...
public class ClientMonoInstaller : MonoInstaller
{
    ...
    public void RegisterHandleBusiness()
    {
        ...
        this.Container.Bind<GamerHandleBusiness>().AsTransient();
        this.Container.Bind<MobHandleBusiness>().AsTransient();
    ...
    {
        this.Container.Bind<TCP>().AsSingle();
        this.Container.Bind<Player>().AsSingle();
        this.Container.Bind<Client>().AsSingle();
    ...
    {
        this.Container.Bind<TCPCommunicationBusiness>().AsTransient();
